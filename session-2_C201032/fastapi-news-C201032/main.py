...
app = FastAPI(
    title="AI based News Summary API (Revised for Assignment by C201032_Sorowar)",
    version="0.2",
...
@app.get("/")
def read_root():
    return {"message": "Welcome to the News Summary API (Revised for Assignment by C201032_Sorowar)!"}
